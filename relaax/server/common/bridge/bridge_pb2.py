...
_ITEM_ITEMTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NUMPY_ARRAY', index=15, number=15,
      options=None,
      type=None),
  ],
