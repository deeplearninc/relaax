...
class ConvNet:
    def __init__(self, params, trainable):
        self.shape = [None, params.screen_width, params.screen_height, params.history_len]
        self.x = tf.placeholder(tf.float32, self.shape)
        self.in_dims = self.shape[1]*self.shape[2]*self.shape[3]
        self.out_dims = params.action_size
        ...
        self.layers = None              # initialize in infer method later
