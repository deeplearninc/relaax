...
class AccumTrainer(object):
    def __init__(self,
        ...
        self._var_list = None           # defined in prepare_minimize method
        self._grad_list = None          # defined in prepare_minimize method
        self._accum_grad_list = None    # defined in prepare_minimize method

    @staticmethod
    def _create_accum_grad(var):
        """
